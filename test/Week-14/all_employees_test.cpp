 ...
 * 
 *      g++ -Wall -Werror -std=c++11 all_employees_test.cpp ../../src/Week-14/employee.cpp ../../src/Week-14/salary_employee.cpp ../../src/Week-14/commission_employee.cpp -o test
 * 
...
int main() {
    try{
        ...
        std::vector<Employee*> empPtr{&sEmp, &commEmp};
