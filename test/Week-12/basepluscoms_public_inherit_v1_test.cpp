 ...
 * 
 *      g++ -Wall -Werror -std=c++11 basepluscoms_public_inherit_v1_test.cpp ../../src/Week-12/basepluscoms_public_inherit_v1.cpp ../../src/Week-12/commission_emply.cpp -o test
 * 
 ...
 * 
 *      g++ -c -Wall -Werror -std=c++11 basepluscoms_public_inherit_v1_test.cpp -o basepluscoms_public_inherit_v1_test.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-12/basepluscoms_public_inherit_v1.cpp -o basepluscoms_public_inherit_v1.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-12/commission_emply_v1.cpp -o commission_emply_v1.o
 *      g++ basepluscoms_public_inherit_v1_test.o basepluscoms_public_inherit_v1.o commission_emply_v1.o -o test
 * 
 */
