 ...
 * 
 *      g++ -Wall -Werror -std=c++11 basepluscoms_public_inherit_test.cpp ../../src/Week-12/basepluscoms_public_inherit.cpp ../../src/Week-12/commission_emply.cpp -o test
 * 
 ...
 * 
 *      g++ -c -Wall -Werror -std=c++11 basepluscoms_public_inherit_test.cpp -o basepluscoms_public_inherit_test.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-12/basepluscoms_public_inherit.cpp -o basepluscoms_public_inherit.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-12/commission_emply.cpp -o commission_emply.o
 *      g++ basepluscoms_public_inherit_test.o basepluscoms_public_inherit.o commission_emply.o -o test
 * 
 */
...
int main() {
    BasePlusCommissionEmployee employee{"Charlie", "Chaplin", "34201-1234567-1", 8000, 0.1, 300};
