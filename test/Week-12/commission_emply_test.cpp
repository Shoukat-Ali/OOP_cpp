 ...
 * 
 *      g++ -Wall -Werror -std=c++11 commission_emply_test.cpp ../../src/Week-12/commission_emply.cpp -o test
 * 
 ...
 * 
 *      g++ -c -Wall -Werror -std=c++11 commission_emply_test.cpp -o commission_emply_test.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-12/commission_emply.cpp -o commission_emply.o
 *      g++ commission_emply_test.o commission_emply.o -o test
 */
