 ...
 * 
 *      g++ -Wall -Werror -std=c++11 myclass1_myclass2_compo_test.cpp ../../src/Week-9/my_class1.cpp ../../src/Week-9/my_class2.cpp -o test
 * 
 ...
 * 
 *      g++ -c -Wall -Werror -std=c++11 myclass1_myclass2_compo_test.cpp -o myclass1_myclass2_compo_test.o
 ...
 *      g++ myclass1_myclass2_compo_test.o my_class1.o my_class2.o -o test
 */
