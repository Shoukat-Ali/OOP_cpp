 ...
 * 
 *      g++ -Wall -Werror -std=c++11 date_employee_compo_test.cpp ../../src/Week-9/date.cpp ../../src/Week-9/employee.cpp -o test
 * 
 ...
 * 
 *      g++ -c -Wall -Werror -std=c++11 date_employee_compo_test.cpp -o date_employee_compo_test.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-9/date.cpp -o date.o
 *      g++ -c -Wall -Werror -std=c++11 ../../src/Week-9/employee.cpp -o employee.o
 *      g++ date_employee_compo_test.o date.o employee.o -o test
 */
