/**
 * This is an attempt to demonstrate the concept of variable scope in C++.
 * Variable scope refers to the region of a program where a variable is defined and can be accessed. 
 * In C++, there are several types of variable scope, including local scope, global scope, and static local scope.
 * 
 * To compile and create executable file of this program, please run the following GNU C++ command in the terminal:
 * 
 *      g++ -std=c++11 scope_demo.cpp -o test
 */
